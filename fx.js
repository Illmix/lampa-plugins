(function() {
  ...
  function component(object) {
    ...
    this.getEpisodes = function(season, call) {
      var episodes = [];
      // Логика взята из vod.js: проверяем source и tmdb_id, чтобы точно найти сериал
